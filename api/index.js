...
function Post({ post: post2, outlet, tabId }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", {
  ...
  }))), !!post2.listsize && !!((_b = post2 == null ? void 0 : post2.listgroup) == null ? void 0 : _b.length) && post2.listgroup.map((group) => /* @__PURE__ */ React.createElement("div", {
    key: group.title,
    className: ""
  }, /* @__PURE__ */ React.createElement("h5", {
    className: "bx-h5"
  }, group.title), !!group.listblock.length && /* @__PURE__ */ React.createElement("ul", {
    className: `bx-list ${bxListSize[post2.listsize || "default"]}`
    ...
    }, !item.url ? itemContents : ((_b2 = item.url) == null ? void 0 : _b2.includes("://")) ? /* @__PURE__ */ React.createElement("a", {
      className: "bx-contents-card-link",
      href: item.url,
      target: "_blank",
      rel: "noreferrer"
    }, itemContents) : /* @__PURE__ */ React.createElement(import_remix12.Link, {
      className: "bx-contents-card-link",
      to: item.url
    }, itemContents));
  })))), /* @__PURE__ */ React.createElement("div", {
...
var loader9 = async ({ request, params }) => {
  ...
  const querySubscription = await datoQuerySubscription({
    request,
    query: queries_exports[category] || post,
    params
  });
