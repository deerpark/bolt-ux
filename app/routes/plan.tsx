  ...
  const list: SectionItem[] = [
    {
      ...
      metas: [
        ...
        { label: 'A/S', value: '1년 무상 지원' },
        { label: '반응형 웹', value: '포함' },
        { label: '다크 모드', value: '미포함' },
        { label: '검색엔진 최적화', value: '포함' },
        { label: '도메인', value: '1년 무료' },
        { label: '호스팅', value: '1년 무료' },
    ...
    {
      title: '홈페이지 제작',
      badge: <span className='bx-badge bx-badge-premium'>PREMIUM</span>,
      link: '/services/homepage',
      label: '자세히 보기',
      photos: photo.homepagepremium,
      metas: [
        { label: '작업일', value: '14일' },
        { label: '최대 페이지', value: '10개' },
        { label: '스타일 가이드', value: '포함' },
        { label: 'A/S', value: '2년 무상 지원' },
        { label: '반응형 웹', value: '포함' },
        { label: '다크 모드', value: '포함' },
        { label: '검색엔진 최적화', value: '포함' },
        { label: '도메인', value: '2년 무료' },
        { label: '호스팅', value: '2년 무료' },
        { label: '구글 워크스페이스', value: '포함' },
        { label: '구글 애널리틱스', value: '포함' },
        { label: '카카오톡 채널', value: '포함' },
        { label: '채널톡', value: '포함' },
        { label: '관리자 도구', value: '지원' },
      ],
      extra: <span>200만원 부터</span>,
    },
    {
      title: '싱글페이지 제작',
      badge: <span className='bx-badge'>BASIC</span>,
